...
#Urutkan dataframe berdasarkan order date dan tipe datetime
...
#membuat widher date input sebagai filter di sidebar dan menambahkan logo perusahaan
...
with st.sidebar:
    ...
    min_date = df_day["order_date"].min().date()
    max_date = df_day["order_date"].max().date()
...
#dataframe yang sudah difilter untuk menghasilkan dataframe yang butuh visualisasi data, menggunakan helper function
...
#informasi daily orders: order harian, total order, revenue dalam range waktu
...
#informasi performa penjualan
#5 produk paling laris dan paling sedikit terjual
